...
var CreditController = /** @class */ (function () {
    function CreditController(creditService) {
        var _this = this;
        ...
        this.getPackagesInfo = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.creditService.getPackages()];
                    case 1:
        ...
        this.stripeSession = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        stripe = new stripe_1.default("".concat(process.env.STRIPE_SECRET_KEY), {
                        ...
                        return [4 /*yield*/, this.creditService.getPackageInfoById(+package_id)];
                    case 1:
                        packageInfo = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.creditService.addCreditRecord(user_id, +package_id, credit)];
                    case 2:
                        _a.sent();
        ...
        this.getTransactionInfo = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var user_id, transactionInfoResult, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        user_id = req.user.id;
                        return [4 /*yield*/, this.creditService.getTransactionInfo(user_id)];
                    case 1:
                        transactionInfoResult = _a.sent();
        ...
        this.getBanks = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.creditService.getBanks()];
                    case 1:
                        data = _a.sent();
